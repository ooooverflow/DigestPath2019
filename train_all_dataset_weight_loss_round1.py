...
def main(params):
	...
	description = 'resnet18_round4_using_best_valid_recall_0.4(round0)_0.4(round1)_0.4(round2)_0.4_multi3(round3)_1e-4_no_pretrain_remove_some_da_dataset_add_data'
...
if __name__ == '__main__':
	...
	params = {
		...
		'test_stride_num': 3,
		'weight_loss': 1,
		'label_csv': 'bbox/retinanet_resnet18_round4_fold_2_weight_loss_1_on_train_data_best_valid_recall_0.4_ensemble_mixmatch(round0)_0.4_ensemble_mixmatch(round1)_0.4_ensemble_mixmatch(round2)_0.4_ensemble_multi3(round3).csv',
		'save_model': True,
		'warmup': False
	}
