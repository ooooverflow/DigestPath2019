...
'_resnet18 4fold_{}_all_dataset(pos+neg)_weight_loss_{}_round1_no_negative_focal_loss_0.2_using_train_data_fold_0_nms_0.4_scorethreshold_0.2'.format(params['test_fold'], params['weight_loss']))
	...
	for epoch in range(params['max_epoch']):
		...
		'templete_ckpt/resnet18_fold_{}_all_dataset_weight_loss_{}_round1_no_negative_focal_loss_0.2'
		'_using_train_data_fold_0_nms_0.4_scorethreshold_0.2_epoch_{}_loss_{}.pth'.
						   format(params['test_fold'], params['weight_loss'], epoch, np.mean(epoch_loss_train)))
