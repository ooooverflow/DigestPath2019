...
for test_fold in range(0, 4):
	pred_csv = './test_result_new/retinanet_resnet18_round{}_test_fold_{}.csv'.format(round, test_fold)
...
result_csv = '../resnet/bbox/retinanet_resnet_18_using_test_prediction_nms_0.4_scorethreshold_0.05_for_bagging_comparation.csv'.format((round+1))
