...
def main(params):
	...
	description = 'resnet18_remove_some_da_cooperative_training'
	if params['writer'] == True:
		writer = SummaryWriter(comment='_4fold_{}_{}_all dataset(pos+neg)_weight_loss_{}_{}'.format(params['test_fold'], params['cooperative'], params['weight_loss'], description))
	...
	for epoch in range(params['max_epoch']):
		...
		torch.save(retinanet.module.state_dict(), 'ckpt_new/latest_fold_{}_{}_all_dataset_weight_loss_{}_{}.pth'.format(params['test_fold'], params['cooperative'], params['weight_loss'], description))
