...
csv_name = os.path.join(result_dir, 'retinanet_resnet18_round1_train_on_fold_0_0_result_on_fold_0_1_weight_loss_1_latest_*_0.5(round0).csv')
...
test_dataset = Ring_Cell_all_dataset('/data/sqy/code/miccai2019/train_test_4/train_0_1.txt')
...
result_csv = './bbox_ct/retinanet_resnet18_round1_for_traning_on_fold_0_0_weight_loss_1_{}_ensemble_mixmatch(round0).csv'.format(score_threshold)
