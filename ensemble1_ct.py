...
csv_name = os.path.join(result_dir, 'retinanet_resnet18_round1_train_on_fold_0_1_result_on_fold_0_0_weight_loss_1_latest_*_0.5(round0).csv')
...
test_dataset = Ring_Cell_all_dataset('/data/sqy/code/miccai2019/train_test_4/train_0_0.txt'.format(test_fold))
...
result_csv = './bbox_ct/retinanet_resnet18_round2_for_traning_on_fold_0_0_weight_loss_1_0.5_ensemble_mixmatch(round0)_{}_ensemble_mixmatch(round1).csv'.format(score_threshold)
