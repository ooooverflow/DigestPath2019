...
result_dir = 'test_result_da_ct'
csv_name = os.path.join(result_dir,
'retinanet_resnet18_round1_train_on_fold_0_*_result_on_test_fold_0_weight_loss_1_latest_*_0.5(round0).csv')
ensemble_csv_list = glob.glob(csv_name)
ensemble_csv_list = [x for x in ensemble_csv_list if 'ensemble' not in x]
# ensemble_csv_list.append(os.path.join(result_dir, 'retinanet_resnet18_round4_fold_0_weight_loss_1_on_test_data_best_valid_recall_original_0.4(round0)_0.4(round1)_0.4(round2)_0.4_multi3(round3).csv'))
...
test_dataset = Ring_Cell_all_dataset('/data/sqy/code/miccai2019/train_test_4/test_{}.txt'.format(0))
...
result_csv = './test_result_da_ct/retinanet_resnet18_round1_train_on_fold_0_(01)_result_on_test_fold_0_weight_loss_1_latest_ensemble_0.5(round0).csv'
