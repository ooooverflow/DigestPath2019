...
for da in da_list:
	# da = 'rotate270'
	result_dict = {}
	result_csv = './test_result_da/retinanet_resnet18_round4_fold_{}_weight_loss_1_on_test_data_best_valid_recall_{}_0.4(round0)_0.4(round1)_0.4(round2)_0.4_multi3(round3)_0925.csv'.format(test_fold, da)
	print(result_csv)
