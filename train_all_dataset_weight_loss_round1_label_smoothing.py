...
import model_all_dataset_weight_loss_label_smoothing as model
import os
...
def main(params):
	...
	description = 'resnet18_round4_using_best_valid_recall_0.4(round0)_0.4(round1)_0.4(round2)_0.4_multi3(round3)_1e-4_no_pretrain_remove_some_da_label_smoothing_0.1'
...
'_4fold_{}_all_dataset(pos+neg)_weight_loss_{}_{}'.format(params['test_fold'], params['weight_loss'], description))
	...
	retinanet = model.resnet18(num_classes=2, pretrained=True, weight_loss=params['weight_loss'], label_smoothing=0.1)
...
if __name__ == '__main__':
	...
	params = {
		...
		'test_stride_num': 3,
		'weight_loss': 1,
		'label_csv': 'bbox/retinanet_resnet18_round4_fold_0_weight_loss_1_on_train_data_best_valid_recall_0.4_ensemble(round0)_0.4_ensemble(round1)_0.4_ensemble(round2)_0.4_multi3(round3).csv',
		'save_model': True,
		'warmup': False
	}
