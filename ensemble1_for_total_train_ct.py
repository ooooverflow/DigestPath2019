...
csv_name = os.path.join(result_dir, 'retinanet_resnet18_round2_train_on_fold_0_*_result_on_fold_0_*_weight_loss_1_latest_*_0.5(round0)_0.5(round1).csv')
...
test_dataset = Ring_Cell_all_dataset('/data/sqy/code/miccai2019/train_test_4/train_0.txt'.format(test_fold))
...
result_csv = './bbox_ct/retinanet_resnet18_round3_using_cooperative_training_weight_loss_1_0.5_ensemble_mixmatch(round0)_0.5_ensemble_mixmatch(round1)_{}_ensemble_mixmatch(round2).csv'.format(score_threshold)
