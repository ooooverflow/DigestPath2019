...
model_path = 'ckpt_new/latest_fold_0_0_all_dataset_weight_loss_1_resnet18_round2_1e-4_no_pretrain_remove_some_da_cooperative_training_0.5(round0)_0.5_multi2(round1).pth'

test_fold = model_path.split('_fold_')[1][0]
cooperative_train = model_path.split('_fold_')[1][2]

# if train on fold_0_1, then test on fold_0_0
if cooperative_train == '1':
	cooperative_result = '0'
else:
	cooperative_result = '1'

test_dataset = Ring_Cell_all_dataset('/data/sqy/code/miccai2019/train_test_4/train_0_1.txt'.format(test_fold, cooperative_train))
...
for da in da_list:
	# da = 'rotate270'
	result_dict = {}
	result_csv = './test_result_da_ct/retinanet_resnet18_round2_train_on_fold_0_0_result_on_fold_0_1_weight_loss_1_latest_{}_0.5(round0)_0.5(round1).csv'.format(da)
	print(result_csv)
