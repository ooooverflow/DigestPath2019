...
for test_fold in range(0, 4):
	pred_csv = './test_result_new/retinanet_resnet18_round0_fold_{}_weight_loss_1_on_test_data_latest.csv'.format(test_fold)
...
result_csv = './bbox/retinanet_resnet_18_using_test_prediction_latest_nms_{}_scorethreshold_{}_for_round{}_training.csv'\
