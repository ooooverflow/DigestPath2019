...
import losses_all_dataset_weight_loss_label_smoothing as losses
...
class ResNet(nn.Module):
	...
	def __init__(self, num_classes, block, layers, weight_loss=1, label_smoothing=0):
		self.inplanes = 64
		...
		self.focalLoss = losses.FocalLoss(weight_loss, label_smoothing)
